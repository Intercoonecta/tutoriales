...
Aqui describimos como acceder a datos en formato raster disponibles de manera libre de la NOAA a traves del servidor [ERDDAP](https://coastwatch.pfeg.noaa.gov/erddap/index.html) utilizando el paquete `rerddap`.
