...
data <- read.csv("~/shared/datos_para_tutoriales/tutoriales/datos_online/datos/Temporal_Ecuadorian Exclusive Economic Zone (Galapagos) - 2023-01-01T00_00_00.000Z,2024-01-01T00_00_00.000Z/layer-activity-data-0/public-global-fishing-effort-v3.0.csv")
...
dataSP <- read.csv("~/shared/datos_para_tutoriales/tutoriales/datos_online/datos/Espacial_Ecuadorian Exclusive Economic Zone (Galapagos) - 2023-01-01T00_00_00.000Z,2024-01-01T00_00_00.000Z/layer-activity-data-0/public-global-fishing-effort-v3.0.csv")
<<<<<<< HEAD

=======
>>>>>>> 46697020a088f4acbf7fddb0b66b2a28ff2d5af4
...
Si se cuenta con el tiempo suficiente, se presentará el uso del paquete `gfwR`
para la descarga de los datos en forma directa desde R.

```{r eval=F}
# Check/install remotes

remotes::install_github("GlobalFishingWatch/gfwr",
                        ref = "develop", ## <- Esto es fundamental, porque cambian los nombres de las funciones.
                        dependencies = TRUE)
...
Desde aca se puede re-hacer los graficos y mapas anteriores, hay que verificar nombres de columnas e ir paso a pasado.
